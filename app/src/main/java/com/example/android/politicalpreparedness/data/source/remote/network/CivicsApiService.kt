...
import com.example.android.politicalpreparedness.data.source.remote.network.jsonadapter.ElectionAdapter
import com.example.android.politicalpreparedness.data.source.remote.network.models.ElectionResponse
...
interface CivicsApiService {
    ...
    suspend fun getRepresentatives(
        @Query("representatives") address: String
